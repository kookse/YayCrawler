...
var pageUrl = casper.cli.get("pageUrl");
var domain = casper.cli.get("domain");
var cookie = decodeURIComponent(decodeURIComponent(casper.cli.get("cookie")));
var deltaResolveServer = casper.cli.get("deltaResolveAddress");
var id = ( new Date()).getTime();
var formSelectable = casper.cli.get("form");
var searchParam = casper.cli.get("searchParam");
var pageParam = null;
if (cookie != null) {
...
casper.start(pageUrl).then(function () {
    this.wait(5000, function () {
        ...
        if (typeof(formSelectable) == "undefined" || formSelectable == "") {
            this.fill(formSelectable, JSON.parse(searchParam), true);
            //this.click('#btn_query');
        }
        this.capture('download1.png');
    });
});
